...
//        mRotateDetector = new RotateGestureDetector(mRotateListener);
    ...
    GestureDetector mGestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            if (onSinglClick != null) {
                onSinglClick.onSingleClick();
            }
            return true;
        }
    });
    ...
    public void setAllowRotate(boolean allowRotate) {
        ...
        if (this.allowRotate) {
            mRotateDetector.setmListener(mRotateListener);
        }
    }

    public interface OnSinglClick {
        void onSingleClick();
    }

    public void setOnSinglClick(OnSinglClick onSinglClick) {
        this.onSinglClick = onSinglClick;
    }

    public OnSinglClick onSinglClick;
